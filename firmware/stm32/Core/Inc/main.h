...
#define SIG_SEL_Pin GPIO_PIN_13
#define SIG_SEL_GPIO_Port GPIOC
#define BUZZER_Pin GPIO_PIN_6
#define BUZZER_GPIO_Port GPIOF
#define SIGNAL_Q_Pin GPIO_PIN_1
#define SIGNAL_Q_GPIO_Port GPIOC
#define SIGNAL_I_Pin GPIO_PIN_3
#define SIGNAL_I_GPIO_Port GPIOC
#define VCO_Pin GPIO_PIN_5
#define VCO_GPIO_Port GPIOA
#define ESP_EN_Pin GPIO_PIN_11
#define ESP_EN_GPIO_Port GPIOD
#define EN_PCB_OUT_Pin GPIO_PIN_2
#define EN_PCB_OUT_GPIO_Port GPIOG
#define EN_PCB_IN_Pin GPIO_PIN_3
